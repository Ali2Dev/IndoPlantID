...
namespace Web.Identity.Services.Concrete
{
    public class EmailService : IEmailService
    {
        ...
        public async Task SendResetPasswordEmailAsync(string resetPasswordEmailLink, string toEmail, string userName)
        {
            ...
            mailMessage.Subject = "InDoPlantId | Şifre Sıfırlama";
            mailMessage.Body = $@"
<html>
<head>
    <style>
...
<body>
    <div class='container'>
        ...
        public async Task SendResetPasswordIsSuccessfulAsync(string userName, string toEmail)
        {
            ...
            mailMessage.Subject = "InDoPlantId | Şifreniz Değiştirildi";
            mailMessage.Body = $@"
<html>
<head>
    <style>
...
<body>
    <div class='container'>
        ...
        public async Task SendConfirmEmailLinkAsync(string confirmEmailLink, string toEmail, string fullName)
        {
            ...
            mailMessage.Subject = "InDoPlantId | Email Onayı";
...
<body>
    <div class='container'>
        ...
        <p>IndoPlantID'ye hoşgeldin! E-mail hesabını aşağıdaki butona ya da ilgili bağlantıya tıklayarak onaylayabilirsin.</p>
        <table cellpadding='0' cellspacing='0' width='100%' border='0'>
            <tr>
                <td>
